...
const testObj = new ObjectModel();
testObj.update({ boards: [{}], foo: '123', bar: 456 });
console.log(JSON.stringify(testObj));
const otherBoard = new boards_1.default();
otherBoard.firmwareDate = "foobar";
testObj.update({ boards: [otherBoard, {}] });
console.log(JSON.stringify(testObj));
